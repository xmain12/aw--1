...
let baseURI = '/apps/' + config.HEROKU.APP_NAME;
   ...
   var l_dsc = ''
    ...
    if (config.LANG == 'EN') {
        ...
        STICKER_on = 'Auto Sticker option turned on!'
        STICKER_off = 'Auto Sticker option turned off'
    ...
    Julie.addCommand({ pattern: 'caption ?(.*)', fromMe: true, desc: 'changes all captions', usage: '.caption *Made by Stefanie*' }, (async (message, match) => {
