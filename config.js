...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? '*© 2021 | Queen Stefanie V 8.52 beta👸*' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '*© 2021 | Queen Stefanie V 8.52 beta👸*' : process.env.BOT_NAME,
    BOT_NAME: process.env.BOT_NAME === undefined ? '*© 2021 | Queen Stefanie V 8.52 beta👸*' : process.env.BOT_NAME,
    ...
    BIO: process.env.BIO === undefined ? '*© 2021 | Queen Stefanie V 8.52 beta👸*' : process.env.BIO,
